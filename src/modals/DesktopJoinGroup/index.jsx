  ...
  return (
    <ModalProvider {...props} appElement={document.getElementById("root")} isOpen={isOpen} className="min-w-[736px]">
      <div className="flex flex-row justify-center w-full">
        <div className="flex flex-row justify-center w-full">
          <div className="flex flex-row justify-center w-full">
            <div className="flex flex-row justify-center w-full pb-[35px] bg-white-A700 rounded-lg">
              <div className="flex flex-col items-center justify-start w-full gap-6">
                ...
                <div className="flex flex-row justify-start items-center w-[91%] gap-[29px]">
                  <div className="flex flex-col items-start justify-start w-[49%] gap-[23px]">
                    <a href="#">
                    ...
                    <div className="flex flex-col items-center justify-start w-full gap-[19px]">
                      <div className="flex flex-col items-center justify-start w-full">
                        ...
                        <Input
                          ...
                          name="email"
                          placeholder="Email"
                          className="w-full mt-[-1px] border-blue_gray-100 border border-solid"
                        />
                        <Input
                          type="password"
                          name="password"
                          ...
                          className="w-full mt-[-1px] gap-[35px] z-[2] border-blue_gray-100 border border-solid"
                        />
                        <Input
                          type="password"
                          name="confirmpassword"
                          placeholder="Confirm Password"
                          className="w-full mt-[-1px] !rounded-bl-sm !rounded-br-sm border-blue_gray-100 border border-solid"
                        />
                      </div>
                    ...
                    <div className="flex flex-col items-center justify-start gap-2">
                      <Button
                        ...
                        className="w-full gap-2.5 !text-black-900 border-blue_gray-100_01 border border-solid !rounded-sm"
                      >
                  ...
                  <div className="flex flex-col items-center justify-start w-[48%] gap-[51px]">
                    <Text size="md" as="p" className="!text-gray-800 text-right">
                      <span className="text-gray-800">Already have an account? </span>
                      <span className="text-blue-A700 font-semibold">Sign In</span>
                    </Text>
                                  ...
                                  <div className="flex flex-row justify-end items-center w-[91%]">
                                    ...
                                    <div className="h-52 w-[98%] ml-[-13px] relative">
                                      ...
                                      <div className="flex flex-row justify-end items-center w-[21%] right-[6%] top-[35%] m-auto absolute">
                                        <Img
                                          src="images/img_fill_57.svg"
                                          alt="fillfiftyseven"
                                          className="h-[7px] z-[1]"
                                        />
                                        <Img
                                          src="images/img_fill_5.svg"
                                          alt="fillfive_one"
                                          className="h-12 ml-[-8px]"
                                        />
                                      </div>
                              ...
                              <div className="flex flex-col items-start justify-start w-[31%] mr-4 z-[1]">
                                <div className="flex flex-col items-start justify-start h-[15px] w-4 z-[1]">
                                  ...
                                  <Img
                                    src="images/img_fill_179.svg"
                                    alt="fill422_one"
                                    className="h-px w-px mt-px ml-0.5"
                                  />
                                </div>
                    ...
                    <Text size="xs" as="p" className="!text-black-900_90 tracking-[-0.09px] text-right opacity-0.6">
