          ...
          <div className="flex flex-row justify-start w-full">
            <div className="flex flex-col items-start justify-start w-full">
              <div className="flex flex-col items-end justify-start w-full">
                ...
                <div className="flex flex-col items-center justify-start w-[17%] mt-[-235px] mr-[202px]">
                  <div className="flex flex-col items-center justify-start w-full">
                    ...
                    <div className="flex flex-row justify-center items-start w-full mt-[31px] gap-[7px]">
                      <Img
                    ...
                    <div className="flex flex-row justify-start items-center w-full mt-[53px] gap-1 max-w-[206px]">
                      <div className="h-[15px] w-4 relative">
                        <Img
                          src="images/img_vector.svg"
                          alt="vector_one"
                          className="h-2.5 w-[9px] bottom-[15%] right-[6%] m-auto opacity-0.3 absolute"
                        />
                        <Img
                          src="images/img_vector_black_900.svg"
                          alt="vector_three"
                          className="justify-center h-[15px] w-4 left-0 bottom-0 right-0 top-0 m-auto absolute"
                        />
                      </div>
                    ...
                    <div className="flex flex-col w-[99%] mt-[23px] gap-[22px]">
                      <div className="flex flex-row justify-between items-center w-full">
                        ...
                        <Button color="black_900" size="xs" className="min-w-[73px] rounded-[12px]">
                          Followed
                        </Button>
                      </div>
                      <div className="flex flex-row justify-between items-center w-full">
                        <div className="flex flex-row justify-start items-center w-[43%] gap-3">
                          <Img src="images/img_rectangle_6_1.png" alt="circleimage" className="h-9 w-9 rounded-[50%]" />
                      ...
                      <div className="flex flex-row justify-between items-center w-full">
                        <div className="flex flex-row justify-start items-center w-[33%] gap-3">
                          <Img src="images/img_rectangle_6_2.png" alt="circleimage" className="h-9 w-9 rounded-[50%]" />
                          <Text as="p">MBA</Text>
                        </div>
                        <Button color="blue_gray_50" size="xs" className="min-w-[60px] rounded-[12px]">
                          Follow
                      ...
                      <div className="flex flex-row justify-between items-center w-full">
                        <div className="flex flex-row justify-start items-center w-[49%] gap-3">
                          <Img src="images/img_rectangle_6_3.png" alt="circleimage" className="h-9 w-9 rounded-[50%]" />
                    ...
                    <Text size="s" as="p" className="mt-[54px] !text-blue-A700 text-right">
                      See More...
                    </Text>
                  </div>
                </div>
              </div>
              <div className="flex flex-col items-center justify-start w-[49%] mt-[-219px] ml-[199px] pb-5 gap-[17px] z-[1] border-gray-300 border border-solid bg-white-A700 rounded">
                <Img
